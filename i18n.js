...
(function () {
  const STRINGS = {
    ...
    gu: {
      ...
      "card.additionalPending": "આગણ ના બાકી",
      "card.method": "પદ્ધતિ:",
      ...
      "modal.additionalPendingAmount": "આગણ બાકી રકમ (₹)",
      "modal.additionalPendingNote": "આગણ બાકી નોંધ",
      "modal.additionalPendingHint": "આગણ બાકી રકમ 0 કરતાં વધારે હોય ત્યારે જ વોટ્સએપમાં બતાવશે.",
      "modal.rate": "માસિક દર (₹)",
      ...
      "err.additionalPendingAmount": "માન્ય આગણ બાકી રકમ દાખલ કરો (>=0).",
