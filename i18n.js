...
(function () {
  const STRINGS = {
    en: {
      ...
      "card.additionalPending": "Additional Pending",
      "card.method": "Method:",
      ...
      "modal.additionalPendingAmount": "Additional Pending Amount (₹)",
      "modal.additionalPendingNote": "Additional Pending Note",
      "modal.additionalPendingHint": "Shown in WhatsApp only when additional pending amount is greater than 0.",
      ...
      "modal.additionalPendingAmountPh": "e.g. 2100",
      "modal.additionalPendingNotePh": "e.g. Old member pending: 3 × 700 = 2100",
      ...
      "err.additionalPendingAmount": "Please enter a valid additional pending amount (>=0).",
      ...
      "toast.syncFailed": "⚠️ Could not sync with Google Sheet. Showing offline data. Tap sync status to retry.",
    ...
    gu: {
      ...
      "card.additionalPending": "વધારાની બાકી",
      "card.method": "પદ્ધતિ:",
      ...
      "modal.additionalPendingAmount": "વધારાની બાકી રકમ (₹)",
      "modal.additionalPendingNote": "વધારાની બાકી નોંધ",
      "modal.additionalPendingHint": "વધારાની બાકી રકમ 0 કરતાં વધારે હોય ત્યારે જ વોટ્સએપમાં બતાવશે.",
      "modal.rate": "માસિક દર (₹)",
      ...
      "modal.additionalPendingAmountPh": "જેમ કે 2100",
      "modal.additionalPendingNotePh": "જેમ કે જૂના મેમ્બર બાકી: 3 × 700 = 2100",
      ...
      "err.additionalPendingAmount": "માન્ય વધારાની બાકી રકમ દાખલ કરો (>=0).",
      ...
      "toast.syncFailed": "⚠️ Google Sheet સિંક ન થયું. ઑફલાઇન ડેટા બતાવી રહ્યા છીએ. ફરી પ્રયાસ કરો.",
